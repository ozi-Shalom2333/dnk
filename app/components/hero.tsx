export default function Hero() {
    return (
      <section className=" relative h-[80vh] md:h-[60vh] lg:h-screen bg-cover lg:bg-cover lg:bg-center bg-no-repeat bg-fixed pt-17 flex flex-col justify-center p-0 md:pl-15 z-1" style={{backgroundImage:`url('https://websitedemos.net/brandstore-02/wp-content/uploads/sites/150/2019/12/home-new-bg-free-img.jpg')`}}>
       ...
       <div className="w-full flex flex-col md:hidden h-full items-center justify-center">
         <h1 className="text-white text-3xl font-bold text-center">Raining Offers For Hot Summer!</h1>
         <p className="text-white text-xl font-bold my-4">25% Off On All Products</p>
